  ...
  return (
    <section className="flex-col bg-white p-8">
      ...
      <p className="text-pretty py-4 text-gray-600">
        I'm a Senior Front-End Engineer who's been getting my hands dirty with all sorts of cool
        projects for over a decade.
      </p>

      <p className="text-pretty pb-8 text-gray-600">
        I specialize in building projects from the ground up, from initial sketches to production
        deployment. I've led teams, optimized performance, implemented responsive designs, and
        architected visually stunning user interfaces that enhance user experience.
      </p>
