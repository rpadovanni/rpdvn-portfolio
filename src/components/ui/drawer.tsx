...
>(({ className, children, ...props }, ref) => {
	...
	return (
		<DrawerPortal>
			<DrawerOverlay className="bg-opacity-50" />
			<DrawerPrimitive.Content
				ref={ref}
				className={cn(
					'fixed z-50 flex h-full flex-col bg-white dark:border-slate-800 dark:bg-slate-950',
					(!direction || direction === 'bottom') && 'inset-x-0 bottom-0 mt-24',
					direction === 'top' && 'right-0 top-0 w-screen',
